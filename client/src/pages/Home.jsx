  ...
  return (
    <>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        <h2 className='text-slate-700 font-bold text-3xl lg:text-6xl'>Find Your next <span className='text-slate-500'>perfect</span> <br />place with ease</h2>
        <p className='text-gray-400 text-xs sm:text-sm'>Zee Estate will help you find your next perfect place to live. <br /> We have a wide range of properties for you to choose from.</p>
        ...
        <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10'>
          {
            offerListings && offerListings.length>0 && (
              <div className='my-3'>
                <div>
                  <h2 className='text-2xl font-semibold text-slate-600'>Recents Offers</h2>
